...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GotomaxxPdfUploadRestResponseOnline : IEquatable<GotomaxxPdfUploadRestResponseOnline>
    {
        /// <summary>
        /// Display URI
        /// </summary>
        /// <value>Display URI</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GotomaxxPdfUploadRestResponseOnline {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GotomaxxPdfUploadRestResponseOnline)obj);
        }

        /// <summary>
        /// Returns true if GotomaxxPdfUploadRestResponseOnline instances are equal
        /// </summary>
        /// <param name="other">Instance of GotomaxxPdfUploadRestResponseOnline to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GotomaxxPdfUploadRestResponseOnline other)
        {
            ...
            return 
                (
                    ...
                    DisplayUri != null &&
                    DisplayUri.Equals(other.DisplayUri)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (DisplayUri != null)
                    hashCode = hashCode * 59 + DisplayUri.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(GotomaxxPdfUploadRestResponseOnline left, GotomaxxPdfUploadRestResponseOnline right)
        {
