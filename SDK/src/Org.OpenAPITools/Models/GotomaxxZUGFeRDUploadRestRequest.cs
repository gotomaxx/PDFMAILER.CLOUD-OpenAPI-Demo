...
{ 
    /// <summary>
    /// ZUGFeRD upload REST request object template for documentation purposes  For letter delivery it&#39;s required to submit the destination country code, if it&#39;s not a national sending.
    /// </summary>
    [DataContract]
    public partial class GotomaxxZUGFeRDUploadRestRequest : IEquatable<GotomaxxZUGFeRDUploadRestRequest>
    {
        /// <summary>
        /// ZUGFeRD XML data (required)
        /// </summary>
        /// <value>ZUGFeRD XML data (required)</value>
        [Required]
        [MinLength(256)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GotomaxxZUGFeRDUploadRestRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GotomaxxZUGFeRDUploadRestRequest)obj);
        }

        /// <summary>
        /// Returns true if GotomaxxZUGFeRDUploadRestRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of GotomaxxZUGFeRDUploadRestRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GotomaxxZUGFeRDUploadRestRequest other)
        {
        ...
        public static bool operator ==(GotomaxxZUGFeRDUploadRestRequest left, GotomaxxZUGFeRDUploadRestRequest right)
        {
