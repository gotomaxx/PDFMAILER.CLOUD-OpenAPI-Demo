...
{ 
    /// <summary>
    /// JSON document object template for documentation purposes and XML transformation  __NOTE__: Auto-complete isn&#39;t an auto-correction - given values have to be correct. The processing order is:  1. Seller 1. Standard VAT (added from your portal meta data, if no VAT was defined, but items or allowance charge use VAT) 1. Buyer 1. Shipping 1. Header 1. Payment 1. Items 1. Allowance charge 1. VAT 1. Summary 1. Attachments  Given values will be validated, if possible - this includes:  - Tax ID - Email address - Phone number - IBAN code - BIC code - Enumeration value - Value type - ZIP code - MIME type
    /// </summary>
    [DataContract]
    public partial class GotomaxxJsonDocument : IEquatable<GotomaxxJsonDocument>
    {
        /// <summary>
        /// Gets or Sets Seller
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GotomaxxJsonDocument {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GotomaxxJsonDocument)obj);
        }

        /// <summary>
        /// Returns true if GotomaxxJsonDocument instances are equal
        /// </summary>
        /// <param name="other">Instance of GotomaxxJsonDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GotomaxxJsonDocument other)
        {
        ...
        public static bool operator ==(GotomaxxJsonDocument left, GotomaxxJsonDocument right)
        {
