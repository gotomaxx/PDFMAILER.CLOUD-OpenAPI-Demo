...
{ 
    /// <summary>
    /// JSON upload REST request object template for documentation purposes  For letter delivery it&#39;s required to submit the destination country code, if it&#39;s not a national sending.
    /// </summary>
    [DataContract]
    public partial class GotomaxxJsonUploadRestRequest : IEquatable<GotomaxxJsonUploadRestRequest>
    {
        /// <summary>
        /// Gets or Sets Json
        /// </summary>
        ...
        public GotomaxxJsonUploadRestRequestJson Json { get; set; }
        ...
        /// <summary>
        /// Try to auto-complete missing values?
        /// </summary>
        /// <value>Try to auto-complete missing values?</value>
        [DataMember(Name="tryAutoComplete", EmitDefaultValue=false)]
        public bool TryAutoComplete { get; set; }

        /// <summary>
        /// Should the recipient data from the buyer object be copied to the base request for the document delivery?
        /// </summary>
        /// <value>Should the recipient data from the buyer object be copied to the base request for the document delivery?</value>
        [DataMember(Name="copyRecipientData", EmitDefaultValue=false)]
        public bool CopyRecipientData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GotomaxxJsonUploadRestRequest {\n");
            sb.Append("  Json: ").Append(Json).Append("\n");
            sb.Append("  Attach: ").Append(Attach).Append("\n");
            sb.Append("  TryAutoComplete: ").Append(TryAutoComplete).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GotomaxxJsonUploadRestRequest)obj);
        }

        /// <summary>
        /// Returns true if GotomaxxJsonUploadRestRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of GotomaxxJsonUploadRestRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GotomaxxJsonUploadRestRequest other)
        {
            ...
            return 
                ...
                (
                    TryAutoComplete == other.TryAutoComplete ||
                    
                    TryAutoComplete.Equals(other.TryAutoComplete)
                ) && 
                (
                    CopyRecipientData == other.CopyRecipientData ||
                    
                    CopyRecipientData.Equals(other.CopyRecipientData)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + TryAutoComplete.GetHashCode();
                    
                    hashCode = hashCode * 59 + CopyRecipientData.GetHashCode();
        ...
        public static bool operator ==(GotomaxxJsonUploadRestRequest left, GotomaxxJsonUploadRestRequest right)
        {
