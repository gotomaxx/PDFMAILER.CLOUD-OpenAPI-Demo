...
{ 
    /// <summary>
    /// XRechnung upload REST request object template for documentation purposes  For letter delivery it&#39;s required to submit the destination country code, if it&#39;s not a national sending.
    /// </summary>
    [DataContract]
    public partial class GotomaxxXRechnungUploadRestRequest : IEquatable<GotomaxxXRechnungUploadRestRequest>
    {
        /// <summary>
        /// XRechnung XML data (required)
        /// </summary>
        /// <value>XRechnung XML data (required)</value>
        [Required]
        [MinLength(256)]
        ...
        /// <summary>
        /// Attach the &#x60;XRechnung.xml&#x60;?
        /// </summary>
        /// <value>Attach the &#x60;XRechnung.xml&#x60;?</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GotomaxxXRechnungUploadRestRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GotomaxxXRechnungUploadRestRequest)obj);
        }

        /// <summary>
        /// Returns true if GotomaxxXRechnungUploadRestRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of GotomaxxXRechnungUploadRestRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GotomaxxXRechnungUploadRestRequest other)
        {
        ...
        public static bool operator ==(GotomaxxXRechnungUploadRestRequest left, GotomaxxXRechnungUploadRestRequest right)
        {
