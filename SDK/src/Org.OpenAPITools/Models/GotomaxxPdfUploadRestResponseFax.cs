...
{ 
    /// <summary>
    /// PDF upload REST fax details response object
    /// </summary>
    [DataContract]
    public partial class GotomaxxPdfUploadRestResponseFax : IEquatable<GotomaxxPdfUploadRestResponseFax>
    {
        /// <summary>
        /// Fax recipient number
        /// </summary>
        /// <value>Fax recipient number</value>
        [Required]
        [DataMember(Name="faxRecipient", EmitDefaultValue=false)]
        public string FaxRecipient { get; set; }


        /// <summary>
        /// Delivery status  Possible status values are:  - `0`: None - `1`: Waiting for delivery - `2`: Delivery - `3`: Sending - `4`: Delivered - `5`: Delivery failed
        /// </summary>
        /// <value>Delivery status  Possible status values are:  - `0`: None - `1`: Waiting for delivery - `2`: Delivery - `3`: Sending - `4`: Delivered - `5`: Delivery failed</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GotomaxxPdfUploadRestResponseFax {\n");
            sb.Append("  FaxRecipient: ").Append(FaxRecipient).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GotomaxxPdfUploadRestResponseFax)obj);
        }

        /// <summary>
        /// Returns true if GotomaxxPdfUploadRestResponseFax instances are equal
        /// </summary>
        /// <param name="other">Instance of GotomaxxPdfUploadRestResponseFax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GotomaxxPdfUploadRestResponseFax other)
        {
            ...
            return 
                (
                    FaxRecipient == other.FaxRecipient ||
                    FaxRecipient != null &&
                    FaxRecipient.Equals(other.FaxRecipient)
                ) && 
                (
                    Status == other.Status ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + FaxRecipient.GetHashCode();
        ...
        public static bool operator ==(GotomaxxPdfUploadRestResponseFax left, GotomaxxPdfUploadRestResponseFax right)
        {
